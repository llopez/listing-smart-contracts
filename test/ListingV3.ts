...
import { ListingV3 } from "../typechain-types";

describe("ListingV3", () => {
  let _listing: ListingV3;
  ...
  const deployContract = async () => {
    ...
    const Listing = await ethers.getContractFactory("ListingV3");
